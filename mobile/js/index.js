...
$(function() {
        ...
        function getdata(data) {
            (function(data) {
                ...
                function generate(data) {
                    ...
                    navi += "</ul>";
                    $(".index>.up>div").html(html).parent().after(navi);
                }
                function autoResize() {
                ...
                function showNavi(index) {
                    ...
                    $(".index>ul>li.active").removeClass();
                    $(".index>ul>li").eq(index).addClass("active");
                }
                function setNavi() {
        ...
        function getdata(data) {
            (function(data, autoPlay) {
                ...
                function resize() {
                    ...
                    nowWidth = $(".index>.down>div").width()-80;
                    $(".index>.down").width(nowWidth);
                    $(".index>.down>div").height(nowWidth / (1225 / (maxsize === 2? 607 : 298))).css("margin-top", nowWidth / (1225 / 17));
                    $(".index>.down>div>div").width(nowWidth / (1225 / (maxsize === 2? 618 : 309)) * $(".index>.down>div>div>a").length);
                    $(".index>.down>div>div>a>img").width(nowWidth / (1225 / (maxsize === 2? 607 : 298))).css("margin-right", nowWidth / (1225 / 11));
                }
                ...
                function next() {
                    if (!$(".index>.down>div>div").is(":animated")) {
                        ...
                        var width = $(".index>.down>div>div>a").width() * maxsize;
    ...
    (function() {
        $(window).resize(function() {
            $(".hot").width($(window).width()).height($(window).width()/601*68);
        }).resize();
        ...
        function getdata(data) {
            ...
            $(window).resize(function() {
                $(".hotbox>a,.hotbox>a>img").width( $(window).width()/2-34 ).height($(window).width()/2-34);
